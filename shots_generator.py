...
[VISUAL DESCRIPTION]
Describe only one character. Do not mention, imply, or allude to any other person, being, or object. Do not describe background, setting, lighting, or camera. Focus only on posture, gestures, micro-movements, breathing, and facial expression of the subject.

Bridge - Picard sitting:
Picard sitting, stern look.

Bridge - Riker standing:
Riker standing, arms crossed, thoughtful expression.

Bridge - Data sitting:
Data sitting, motionless, faint head tilt.

Bridge - Worf standing:
Worf standing, rigid posture, alert expression.

Bridge - Troi sitting:
Troi sitting, calm demeanor, gentle breathing.

Bridge - Geordi standing:
Geordi standing, slight lean forward, focused look.

[CHARACTERS]
Picard: Captain Picard of the starship Enterprise.
Riker: Picard's first officer on the Enterprise.
Troi: The councelor on the Enterprise.
Geordi: Engineering guru of the Enterprise.
Data: Evil android, very fucked up and evil.
...
Rules:
- Write as many shots as needed (typically 4-8) to convey the intended narrative clearly and naturally.
